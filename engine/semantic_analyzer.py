...
class SemanticAnalyzer:
    ...
    # --- Declarations (Mapped to engine/ast.py) ---
    ...
    def visit_ForStmt(self, node):
        self.enter_scope()
        # Loop variables are int32 by default in Quantel
    ...
    def get_type(self, node):
        ...
        # Handle raw literals from parser
        ...
        if cls in ['ArrayLiteral', 'ArrayAccess']:
            return "float32"
